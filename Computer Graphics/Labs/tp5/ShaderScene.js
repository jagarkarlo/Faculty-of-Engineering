...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.texture = new CGFtexture(this, "textures/waterTex.jpg");  // Glavna tekstura (voda)
        this.appearance.setTexture(this.texture);
        this.appearance.setTextureWrap('REPEAT', 'REPEAT');

        this.texture2 = new CGFtexture(this, "textures/waterMap.jpg");  // Heightmap
		...
		this.testShaders = [
				...
				new CGFshader(this.gl, "shaders/texture1.vert", "shaders/grayscale.frag") , // Grayscale Shader
				new CGFshader(this.gl, "shaders/water.vert", "shaders/water.frag") // Water Shader
		...
		this.positionShader = new CGFshader(this.gl, "shaders/position.vert", "shaders/position.frag");
	...
	display() {
		...
		if (this.selectedExampleShader === 9) {
			this.setActiveShader(this.positionShader);
		} else if (this.selectedExampleShader >= 0 && this.selectedExampleShader < this.testShaders.length) {
