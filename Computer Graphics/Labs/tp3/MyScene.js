...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram, this.prism, this.cylinder, this.unitcube];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Tangram': 3, 'Prism': 4, 'Cylinder': 5,'Unit Cube': 6};
    ...
    initMaterials() {
        ...
        // Cor madeira, baixa componente especular
        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(0.4, 0.2, 0.0, 1.0);
        this.material4.setDiffuse(0.5, 0.3, 0.1, 1.0);
